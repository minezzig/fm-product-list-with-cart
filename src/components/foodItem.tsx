...
//   return (
//     <div className="flex flex-1 flex-col">
//       <div className={`overflow-hidden rounded-xl border-2 ${selectedName === foodItem.name ? "border-red" : "border-transparent"}`} onClick={() => handleSelect(foodItem.name)} >
//         <img src={image.mobile} alt={name} className="md:aspect-square md:object-cover" />
//       </div>
//       <div className={`min-w-1/3 flex -translate-y-1/2 cursor-pointer items-center justify-center gap-2 self-center rounded-3xl border border-rose4 bg-rose1 p-3 text-center transition hover:bg-rose2 ${selectedName === foodItem.name ? "bg-red" : "bg-none"}`}>
...
//           <div>
//             <div
//               className="hover:text- flex h-5 w-5 items-center justify-center rounded-full border border-white hover:bg-red"
//               onClick={() => handleDecrease(name)}
//             >
